    ...
    link.addEventListener('click', function (event) {
      ...
      function step(time) {
        ...
        let progress = time - start,
          // number of pixels we need to scroll through during the animation
...
const sliders = (slides, dir, prev, next) => {
  ...
  //Если селекторы кнопок не были переданы, этот блок кода не сломает остальную логику кода
  try {
  ...
  // При наведении курсора на слайдер - выключается автоматическое прееключение
